...
<h3>學習紀錄</h3>
<li>0816：</li>
  <li fontsize=14 fontcolour="red">使用 Visual Studio 建立新的專案</li>
  <li fontsize=14 fontcolour="red">選擇＂空的 ASP.NET Core＂ 專案範本</li>
    <img width="1008" height="891" alt="image" src="https://github.com/user-attachments/assets/5891f9da-0065-4179-b4d0-7621b159f614" />
  <li fontsize=14 fontcolour="red"><b>初始畫面如下：</b></li>
