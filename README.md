...
<h3>學習紀錄</h3>
<li>0816：</li>
  <li style = "font-size:16px colour:red;">使用 Visual Studio 建立新的專案</li>
  <li style = "font-size:16px colour:red;">選擇＂空的 ASP.NET Core＂ 專案範本</li>
    <img width="1008" height="891" alt="image" src="https://github.com/user-attachments/assets/5891f9da-0065-4179-b4d0-7621b159f614" />
  <li style = "font-size:16px color:red;"><b>初始畫面如下：</b></li>
